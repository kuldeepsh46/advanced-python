...
# else:
#   print("String does not contain any punctuation")

# generate a secure random password
passChars = string.ascii_letters + string.digits + string.punctuation
randomPass = '' . join(secrets.choice(passChars) for i in range(10))
print(randomPass)
